    ...
    \section{Derivation}\label{sec:derivation}
       ...
       \begin{align*}
        ...
        \begin{align} 
            ...
            &= \sum_{\kappa} \left|C_\kappa\right|^2 \int^\infty_{-\infty} \frac{d\epsilon}{2\pi\imath} \left(-\mathscr{G}^{\kappa}_{ii} (\epsilon)\right) \nonumber\\
            &= \sum_{\kappa} \left|C_\kappa\right|^2 \int^\infty_{-\infty} \frac{d\epsilon}{2\pi} \left[ \sum_\alpha f_\alpha(\epsilon) \mathscr{G}^{\kappa+}(\epsilon) \Gamma^\alpha \mathscr{G}^{\kappa-}(\epsilon)\right]_{ii} \nonumber\\ 
